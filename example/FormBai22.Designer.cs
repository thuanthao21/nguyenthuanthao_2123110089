namespace example
{
    partial class FormBai22
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Lưu ý: Các cột sẽ được map dữ liệu tự động
            ...
            // 
            // Cấu hình Cột (Rất quan trọng cho Binding)
            // 
            this.colId.HeaderText = "Mã nhân viên";
            this.colId.DataPropertyName = "Id"; // Map với property Id của Class Employee

            this.colName.HeaderText = "Tên nhân viên";
            this.colName.DataPropertyName = "Name"; // Map với Name
            this.colName.Width = 150;

            this.colAge.HeaderText = "Tuổi";
            this.colAge.DataPropertyName = "Age"; // Map với Age
            this.colAge.Width = 50;

            this.colGender.HeaderText = "Giới tính (Nam)";
            this.colGender.DataPropertyName = "Gender"; // Map với Gender
            ...
            // 
            // Các control khác (Label, Textbox, Button)
            // 
            ...
            this.Name = "FormBai22";
            this.Text = "Form1";
            this.Load += new System.EventHandler(this.FormBai22_Load);
